	 ...
	 ТекстЗапроса="ВЫБРАТЬ
				  ...
				  Если ИмяВариантаОтчета="По подразделениям" или ИмяВариантаОтчета="По периодам"  Тогда
					  Если НЕ ЭтоОСП Тогда
						  ТекстЗапроса=СтрЗаменить(ТекстЗапроса,"Подразделение В ИЕРАРХИИ (&ОСП)","Подразделение =&ОСП");   
					  КонецЕсли;
				  Иначе
...
Функция   ТекстЗапросаРасшифровкаВыручки(ВыбранноеОСП)
	Текстзапроса="ВЫБРАТЬ
	             ...
	             |ПО
	             |	ОБЩИЕ";
	Если ИмяВариантаОтчета="По подразделениям" Или  ИмяВариантаОтчета="По месяцам" ИЛИ  ИмяВариантаОтчета="По кварталам" Тогда
